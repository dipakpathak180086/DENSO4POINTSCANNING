...
{
    public partial class frmImportModelDataMaster : Form
    {


        #region Variables

        private BL_IMPORT_MODEL_MASTER _blObj = null;
        ...
        public frmImportModelDataMaster()
        {
            try
            {
                InitializeComponent();
                _blObj = new BL_IMPORT_MODEL_MASTER();
            }
            catch (Exception ex)
            {
            ...
            try
            {
                if (ValidateInput())
                {
                    ...
                    for (int i = 0; i < dgv.Rows.Count; i++)
                    {
                        ...
                        _plObj.Model = dgv.Rows[i].Cells[0].Value.ToString();
                        _plObj.PartNo1 = dgv.Rows[i].Cells[1].Value.ToString();
                        _plObj.PartNo2 = dgv.Rows[i].Cells[2].Value.ToString();
