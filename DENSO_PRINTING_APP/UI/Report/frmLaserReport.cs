...
{
    public partial class frmLaserReport : Form
    {

        #region Variables

        private BL_LASER_REPORT _blObj = null;
        private PL_LASER_REPORT _plObj = null;
        ...
        public frmLaserReport()
        {
            try
            {
                InitializeComponent();
                _blObj = new BL_LASER_REPORT();
                _plObj = new PL_LASER_REPORT();
            }
            catch (Exception ex)
            {
